  ...
  return (
    <div style={s}>
      <div style={container}>
        ...
        <p style={ps}>
          KotvukAI использует <strong style={{ color: '#e0e0e0' }}>Groq API</strong> (moonshotai/kimi-k2-instruct) для AI-анализа.
          Это означает:
        </p>
        <ul style={uls}>
          <li>AI-запросы обрабатываются через серверы Groq. Groq не хранит запросы дольше 24 часов согласно их политике конфиденциальности</li>
