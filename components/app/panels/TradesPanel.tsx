...
const PAIRS = [
  ...
  'LINK/USDT','UNI/USDT','AAVE/USDT','CRV/USDT','MKR/USDT',
  'COMP/USDT','SNX/USDT','1INCH/USDT','BAL/USDT','SUSHI/USDT',
  'LTC/USDT','BCH/USDT','ATOM/USDT','TRX/USDT','ETC/USDT',
  'XLM/USDT','ALGO/USDT','NEAR/USDT','FTM/USDT','ICP/USDT',
  'OP/USDT','ARB/USDT','SUI/USDT','APT/USDT','SEI/USDT',
  'TIA/USDT','INJ/USDT','MANTA/USDT','STRK/USDT','ZK/USDT',
  'SHIB/USDT','PEPE/USDT','FLOKI/USDT','WIF/USDT','BONK/USDT',
  'SAND/USDT','MANA/USDT','APE/USDT','AXS/USDT','GALA/USDT',
  'FET/USDT','AGIX/USDT','RNDR/USDT','WLD/USDT','TAO/USDT',
  'FIL/USDT','AR/USDT','GRT/USDT','LDO/USDT','RUNE/USDT',
  'PENDLE/USDT','JUP/USDT','PYTH/USDT','W/USDT','ENA/USDT',
]
